...
def print_statistics(students: dict, exercises: dict, exam_points: dict):
    print(f'{"name":38}{"exec_nbr":10}{"exec_pts.":10}{"exm_pts.":10}{"tot_pts.":10}{"grade":10}')
    for id, name in students.items():
        ...
        print(f"{name:30}{exercises_total:10}{exercises_point_total:10}{exam_points_total:10}{total_points:10}{grade:10}")
...
if __name__ == "__main__":
    if False:
        ...
        print_statistics(students, exercises, exam_points)
